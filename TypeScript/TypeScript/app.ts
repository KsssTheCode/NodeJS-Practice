...
buttonElement.addEventListener('click', () => {
  ...
  numResults.push(result as number); //numResults배열에 result값(number타입)을 첫번쨰로 push
  textResults.push(stringResult as string); //textResults배열에 stringResult값(string타입)을 첫번쨰로 push
